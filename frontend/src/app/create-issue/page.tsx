...
export default function CreateIssuePage() {
  ...
  const addGitHubTags = async (githubUrl: string, difficulty: Difficulty, bountyAmount: string) => {
    ...
    try {
      ...
      const NexusLabel = 'Nexus-bounty';

      const labelsToAdd = [difficultyLabel, bountyLabel, NexusLabel];
  ...
  const approveAndCreateIssue = async () => {
    ...
    try {
      ...
      const newIssue = await githubApi.createIssue(owner, repo, {
        ...
        body: analysisResult.github_payload.body || 'This issue was generated by Nexus.',
        labels: labels
      });
  ...
  const handleCreateBounty = async () => {
    ...
    try {
      ...
      const description = formData.description || "Issue created via Nexus platform";
